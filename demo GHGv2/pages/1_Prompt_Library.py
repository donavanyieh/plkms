...
<style>
    ...
    /* CSS Variables for easy color management - Forest-focused sustainability theme */
    :root {
        --primary-forest: #1b5e20;
        --primary-sage: #66bb6a;
        --secondary-forest: #2e7d32;
        --moss-green: #81c784;
        --light-green: #e8f5e8;
        --deep-forest: #0d4f14;
        --accent-gradient: linear-gradient(135deg, #1b5e20 0%, #0d4f14 50%, #1b5e20 100%);
        --subtle-gradient: linear-gradient(135deg, #1b5e20 0%, #0d4f14 35%, #1b5e20 100%);
        --light-gradient: linear-gradient(135deg, #e8f5e8 0%, #81c784 15%, #e8f5e8 100%);
    }
