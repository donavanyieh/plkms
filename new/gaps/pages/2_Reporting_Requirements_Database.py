...
st.markdown("# IFRS Disclosure Requirements - Template")
st.markdown("## As of May 2025")

# Create mock dataframe for IFRS disclosure requirements
ifrs_data = {
    'Requirement ID': ['IFRS-S1-001', 'IFRS-S1-002', 'IFRS-S1-003', 'IFRS-S2-001', 'IFRS-S2-002', 'IFRS-S2-003', 'IFRS-S1-004', 'IFRS-S2-004'],
    'Standard': ['IFRS S1', 'IFRS S1', 'IFRS S1', 'IFRS S2', 'IFRS S2', 'IFRS S2', 'IFRS S1', 'IFRS S2'],
    'Category': ['Governance', 'Strategy', 'Risk Management', 'Climate Metrics', 'Climate Targets', 'Scenario Analysis', 'Metrics & Targets', 'Transition Plans'],
    'Disclosure Requirement': [
        ...
        'Climate-related targets and progress against targets',
        'Climate-related scenario analysis and resilience planning',
        'Metrics used to measure progress on sustainability matters',
        'Climate transition plan including key milestones and actions'
    ],
    'Mandatory': ['Yes', 'Yes', 'Yes', 'Yes', 'Yes', 'Conditional', 'Yes', 'Conditional'],
    'Effective Date': ['2024-01-01', '2024-01-01', '2024-01-01', '2024-01-01', '2024-01-01', '2024-01-01', '2025-01-01', '2025-01-01'],
    'Implementation Status': ['Complete', 'In Progress', 'Not Started', 'Complete', 'In Progress', 'Not Started', 'Not Started', 'Not Started'],
    'Priority': ['High', 'High', 'Medium', 'High', 'High', 'Medium', 'Medium', 'Low']
}

df = pd.DataFrame(ifrs_data)
...
with pd.ExcelWriter(output, engine='openpyxl') as writer:
    df.to_excel(writer, index=False, sheet_name='IFRS Requirements')
excel_data = output.getvalue()

st.download_button(
    label="Download as Excel",
    data=excel_data,
    file_name="ifrs_disclosure_requirements.xlsx",
