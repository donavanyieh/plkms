...
st.selectbox("Select model:", ["Edit here"], index=0, key="supervisor_model")

st.markdown("## Interviewer agent")
st.selectbox("Select model:", ["Edit here"], index=0, key="interviewer_model")

st.markdown("## Scoring agent")
st.selectbox("Select model:", ["Edit here"], index=0, key="scoring_model")
